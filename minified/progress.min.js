...
c=0,d=this._targetElement.length;c<d;c++){var b=this._targetElement[c],f=g(b);if(!f)return;(function(a,b){a.parentNode.className+=" progressjs-end";setTimeout(function(){a.parentNode.parentNode&&(a.parentNode.parentNode.removeChild(a.parentNode),b.removeAttribute("data-progressjs"))},1E3)})(f,b)}if(window._progressjsIntervals[a])try{clearInterval(window._progressjsIntervals[a]),window._progressjsIntervals[a]=null,delete window._progressjsIntervals[a]}catch(e){}}}function r(){var a,c=document.createElement("fakeelement"),
