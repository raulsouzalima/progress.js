...
""))&&(k.call(this,b,100),e=500);(function(a,b){setTimeout(function(){a.parentNode.className+=" progressjs-end";setTimeout(function(){a.parentNode.parentNode.removeChild(a.parentNode);b.removeAttribute("data-progressjs")},1E3)},e)})(f,b)}if(window._progressjsIntervals[a])try{clearInterval(window._progressjsIntervals[a]),window._progressjsIntervals[a]=null,delete window._progressjsIntervals[a]}catch(t){}}}function s(){var a=this._targetElement[0];if(a){for(var a=parseInt(a.getAttribute("data-progressjs")),
